#v3.3.1 for dimming with lookup table and flux averaging
import configparser
...
#       create list for averaging (13 works for me, change for faster/slower)
...
#2        self.inp = [0.1,  1,  2,  3,  5,  10,  15,  20,  30]
#2        self.uit = [  3, 10, 20, 30, 50, 110, 120, 160, 180]

#1        self.inp = [0.1,  1,  2,  3,  5,   6,  10,  20,  30] 
#1        self.uit = [  3, 17, 30, 43, 70, 100, 150, 200, 230]
    ...
    def dimbright(self):                       #sets the global brightness averaged via a list
        self.lijst.pop(0)
        self.lijst.append(BrightViaLUT(self))
        self.setBrightness (sum(self.lijst)/len(self.lijst))
